...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "CRYPTOPP_8_8_0"
  WORKING_DIRECTORY "/Users/sesame/Desktop/CECILIA/build/dependencies/cryptopp-cmake/cryptopp"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "CRYPTOPP_8_8_0")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("CRYPTOPP_8_8_0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/CRYPTOPP_8_8_0")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"CRYPTOPP_8_8_0\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/sesame/Desktop/CECILIA/build/dependencies/cryptopp-cmake/cryptopp'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/sesame/Desktop/CECILIA/build/dependencies/cryptopp-cmake/cryptopp'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
